---
title: 'Toyota Data Neural Network '
author: "Bryant Lum"
output:
...
final_stepwise.model <- lm(Sales ~ Week + Model + Region + Website_Visits.Paid.BAT + 
    CTA1.Paid.BAT + CTA2.Paid.BAT + Website_Visits.Paid.TCOM + 
    CTA1.Organic.TCOM + CTA1.Paid.TCOM + CTA2.Organic.TCOM + 
    CTA2.Paid.TCOM + Lead_Sales.Category_7 + Lead_Sales.Category_5 + 
    Lead_Sales.Category_1 + Lead_Sales.Category_6 + Lead_Sales.Category_4 + 
    Lead_Sales.Category_9 + Lead_Sales.Category_7_lag1 + Lead_Sales.Category_7_lag4 + 
    Lead_Sales.Category_5_lag1 + Lead_Sales.Category_5_lag4 + 
